...
const slides: SlideData[] = [
  {
    ...
    description:
      "Confiez la gestion de vos biens à un expert international. Nous valorisons votre patrimoine immobilier avec rigueur.",
    image:
  ...
  },
  {
    ...
    description:
      "Une flotte de véhicules de prestige et utilitaires adaptée à tous vos besoins de mobilité, à court ou long terme.",
    image:
  ...
  },
  {
    ...
    description:
      "Bénéficiez de notre expertise pour sécuriser vos transactions et optimiser vos investissements internationaux.",
    image:
      "https://images.unsplash.com/photo-1454165833767-027eeef1596e?auto=format&fit=crop&q=80",
    color: "blue",
    icon: <Gavel size={24} />,
  },
];
            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-8 w-full">
              ...
              >
                ...
                <div className="flex flex-wrap gap-4">
                  {/* Premier bouton : Lien vers les services */}
                  <a
                    href="/services" // Remplace par ton URL
                    className={`inline-flex items-center justify-center px-8 py-4 rounded font-bold text-white transition transform hover:scale-105 ${
                      slide.color === "blue"
                        ? "bg-[#1d70b8] hover:bg-[#165a94]"
                        : "bg-[#ef811d] hover:bg-[#d4721a]"
                    }`}
                  >
                    DÉCOUVRIR NOS SERVICES
                  </a>

                  {/* Deuxième bouton : Lien vers le contact */}
                  <a
                    href="/contact" // Remplace par ton URL
                    className="inline-flex items-center justify-center px-8 py-4 rounded font-bold text-white border-2 border-white/30 hover:bg-white/10 transition transform hover:scale-105"
                  >
                    NOUS CONTACTER
                  </a>
                </div>
