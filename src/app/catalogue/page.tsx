      ...
      <div className="bg-[#1d70b8] py-16 text-white mb-12">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 text-center">
          ...
          <p className="text-blue-100 text-lg max-w-2xl mx-auto">
            Trouvez le bien immobilier de vos rêves ou votre prochain véhicule
            parmi nos meilleures offres.
          </p>
        </div>
      </div>
        ...
        {filteredData.length > 0 ? (
              ...
              >
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 flex gap-2">
                    <span
                      className={`px-3 py-1 rounded shadow-sm text-white text-[10px] font-bold uppercase ${
                ...
                <div className="p-6">
                  ...
                  <p className="text-xl font-black text-[#1d70b8] mb-4">
                    {item.price}
                  </p>
                    ...
                    {item.category === "immo" ? (
                      <>
                        <div className="flex items-center gap-1 text-gray-500 text-xs">
                          <Home size={14} /> {(item as any).area}
                        </div>
                        <div className="flex items-center gap-1 text-gray-500 text-xs">
                          <BedDouble size={14} /> {(item as any).rooms} Ch.
                        </div>
                      </>
                    ) : (
                      <>
                        <div className="flex items-center gap-1 text-gray-500 text-xs">
                          <Fuel size={14} /> {(item as any).fuel}
                        </div>
                        <div className="flex items-center gap-1 text-gray-500 text-xs">
                          <Gauge size={14} /> {(item as any).km}
                        </div>
                      </>
                    )}
                  </div>
          ...
          <div className="text-center py-20 bg-white rounded-3xl shadow-inner">
            ...
            <button
              ...
              className="mt-4 text-[#ef811d] font-bold underline"
            >
